...
/** Alias BibzWhats (nama Baileys* dipertahankan untuk kompatibilitas). */
export type BibzWhatsEventMap = BaileysEventMap;
export type BibzWhatsEvent = BaileysEvent;
export type BibzWhatsEventEmitter = BaileysEventEmitter;
