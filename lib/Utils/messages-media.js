...
export const downloadContentFromMessage = async ({ mediaKey, directPath, url }, type, opts = {}) => {
    // BibzWhats: utamakan directPath (host mmg.whatsapp.net) — beberapa pesan membawa
    // url dengan host usang (a.whatsapp.net → ENOTFOUND) tapi directPath valid (upstream PR #2778)
...
const uploadWithFetch = async ({ url, filePath, headers, timeoutMs, agent }) => {
    ...
    // Native fetch hanya menerima dispatcher gaya Undici, bukan https.Agent biasa (upstream #2557)
